...
class CocoDataset(data.dataset.Dataset):
    ...
    def __init__(self, path, resize, max_size, stride, annotations=None, transforms=None, training=False):
        super().__init__()
...
class DataIterator():
    ...
    def __init__(self, path, resize, max_size, batch_size, stride, world, annotations, transforms=None, training=False):
        self.resize = resize
        self.max_size = max_size

        self.dataset = CocoDataset(path, resize=resize, max_size=max_size,
                                   stride=stride, annotations=annotations, transforms=transforms, training=training)
